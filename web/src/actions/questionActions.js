...
export function voteUp(answerId, userId, questionId) {
    return async dispatch => {
        dispatch(loading())
        try {
            await fetch(`${URL_BASE}/vote/up/${answerId}`,
                {
                    method: 'PUT',
                    mode: 'cors',
                    headers: {
...
export function voteDown(answerId, userId, questionId) {
    return async dispatch => {
        dispatch(loading())
        try {
            await fetch(`${URL_BASE}/vote/down/${answerId}`,
                {
                    method: 'PUT',
                    mode: 'cors',
                    headers: {
